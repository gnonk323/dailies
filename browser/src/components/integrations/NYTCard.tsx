...
import { CircleCheck, RefreshCw, Check, X } from "lucide-react";
    ...
    <div className="rounded-lg border border-border p-3 flex flex-col gap-2.5">
      ...
      <div className="flex flex-col gap-1">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <span className="text-[11px] font-medium uppercase text-muted-foreground">mini crossword</span>
          ...
          <div>
            <span className="text-[11px] font-medium uppercase text-muted-foreground">midi crossword{midi.title && ` - "${midi.title}"`}</span>
            <div className="flex items-center gap-1">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-[11px] font-medium uppercase text-muted-foreground">wordle</span>
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-[11px] font-medium uppercase text-muted-foreground">connections</span>
